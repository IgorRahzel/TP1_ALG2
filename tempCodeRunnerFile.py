...
def lz78_compression(input_file,firstLook = False,bitsSize = None):
...
#Compression
input_file = 'teste1.txt'
num_nodes = lz78_compression(input_file)
num_nodes_log_2 = log2(num_nodes)
num_nodes_log_2 = ceil(num_nodes_log_2)
print(num_nodes_log_2)
lz78_compression(input_file,firstLook=True,bitsSize = num_nodes_log_2)
